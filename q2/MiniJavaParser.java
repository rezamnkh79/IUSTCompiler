// Generated from C:/Users/asus/Desktop/IUSTCompiler/q2\MiniJava.g4 by ANTLR 4.9.1
...
public class MiniJavaParser extends Parser {
	...
	public static final int
		...
		TRUE=17, VOID=18, WHILE=19, AND=20, OR=21, ASSIGN=22, GT=23, LT=24, GE=25, 
		LE=26, PLUS=27, MINUS=28, TIMES=29, BANG=30, L_PAREN=31, R_PAREN=32, L_BRACK=33, 
		R_BRACK=34, BraketOpen=35, BraketClose=36, COMMA=37, DOT=38, SEMI=39, 
		ID=40, INT_VAL=41, WS=42, COMMENT=43, LINE_COMMENT=44;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TRUE", "VOID", "WHILE", "AND", "OR", "ASSIGN", "GT", "LT", "GE", "LE", 
			"PLUS", "MINUS", "TIMES", "BANG", "L_PAREN", "R_PAREN", "L_BRACK", "R_BRACK", 
			"BraketOpen", "BraketClose", "COMMA", "DOT", "SEMI", "ID", "INT_VAL", 
	...
	public static class MainClassContext extends ParserRuleContext {
		...
		public List<TerminalNode> BraketOpen() { return getTokens(MiniJavaParser.BraketOpen); }
		public TerminalNode BraketOpen(int i) {
			return getToken(MiniJavaParser.BraketOpen, i);
		}
		...
		public List<TerminalNode> BraketClose() { return getTokens(MiniJavaParser.BraketClose); }
		public TerminalNode BraketClose(int i) {
			return getToken(MiniJavaParser.BraketClose, i);
		}
	...
	public static class ClassDeclarationContext extends ParserRuleContext {
		...
		public TerminalNode BraketOpen() { return getToken(MiniJavaParser.BraketOpen, 0); }
		public TerminalNode BraketClose() { return getToken(MiniJavaParser.BraketClose, 0); }
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << IF) | (1L << WHILE) | (1L << BraketOpen) | (1L << ID))) != 0)) {
				{
				{
				setState(93);
				statement();
	...
	public static final String _serializedATN =
		...
		"\3\t\3\t\3\t\3\t\3\t\3\t\3\t\7\t\u00d1\n\t\f\t\16\t\u00d4\13\t\5\t\u00d6"+
		"\n\t\3\t\7\t\u00d9\n\t\f\t\16\t\u00dc\13\t\3\t\2\3\20\n\2\4\6\b\n\f\16"+
		"\20\2\3\3\2\35\36\2\u00f7\2\22\3\2\2\2\4\33\3\2\2\2\6-\3\2\2\2\bB\3\2"+
		...
		"\2\2\u008e\u008f\7*\2\2\u008f\u0090\7\30\2\2\u0090\u0091\5\20\t\2\u0091"+
		"\u0092\7)\2\2\u0092\u009c\3\2\2\2\u0093\u0094\7*\2\2\u0094\u0095\7#\2"+
		"\2\u0095\u0096\5\20\t\2\u0096\u0097\7$\2\2\u0097\u0098\7\30\2\2\u0098"+
		...
		"\7\"\2\2\u00ad\u00ae\7 \2\2\u00ae\u00b4\5\20\t\4\u00af\u00b0\7!\2\2\u00b0"+
		"\u00b1\5\20\t\2\u00b1\u00b2\7\"\2\2\u00b2\u00b4\3\2\2\2\u00b3\u009d\3"+
		"\2\2\2\u00b3\u009f\3\2\2\2\u00b3\u00a0\3\2\2\2\u00b3\u00a1\3\2\2\2\u00b3"+
		"\u00a2\3\2\2\2\u00b3\u00a3\3\2\2\2\u00b3\u00a9\3\2\2\2\u00b3\u00ad\3\2"+
		"\2\2\u00b3\u00af\3\2\2\2\u00b4\u00da\3\2\2\2\u00b5\u00b6\f\22\2\2\u00b6"+
		"\u00b7\7\26\2\2\u00b7\u00d9\5\20\t\23\u00b8\u00b9\f\21\2\2\u00b9\u00ba"+
		"\7\32\2\2\u00ba\u00d9\5\20\t\22\u00bb\u00bc\f\20\2\2\u00bc\u00bd\t\2\2"+
		"\2\u00bd\u00d9\5\20\t\21\u00be\u00bf\f\17\2\2\u00bf\u00c0\7\37\2\2\u00c0"+
